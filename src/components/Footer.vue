<template>
  <a-layout-footer style="background: rgb(83, 7, 7);">
    <div class="main-footer">
      <div style="display:block;">
        <h2 itemprop="name" style="display:none;">Unidad Educativa El Carmen</h2>
        ...
        <address itemtype="http://schema.org/Organization">
          ...
          <div class="footer-info">
            ...
            <ul class="list">
              <li>
                Dirección:
                <span itemprop="address">9 de octubre y libertad</span>
              </li>
              <li>
                Telefóno:
                <span itemprop="telephone">052 660-117</span>
              </li>
              <li>
                Correo:
                <a href="mailto:d13h01438ec@gmail.com" itemprop="email">d13h01438ec@gmail.com</a>
              </li>
            </ul>
          </div>
        </address>
